    ...
    <div  className='max-w-lg flex flex-col gap-2 text-sm'>

      {
        ...
        <label htmlFor='image'>
          <div className='inline-block relative cursor-pointer'>
            ...
            <img src={image ? '':assets.upload_icon  } className='w-10 absolute bottom-12 right-12' alt="" />
          </div>
      ...
      <div >
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ? 
            <select className='m-w-20 bg-gray-100' onChange={e=> setUserData(prev =>({...prev,gender:e.target.value}))}>
          ...
          {
            isEdit ? 
            <input className='m-w-20 bg-gray-100' type="date" value={userData.dob} onChange={e=> setUserData(prev =>({...prev,dob:e.target.value}))}/>:
